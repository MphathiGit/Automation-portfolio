...
public class LandingPage extends BaseTest{
	    ...
	    public static void clickOnDateField() {
	    	String departDateFieldXpath = "//span[@class='sb-date-field__icon sb-date-field__icon-btn bk-svg-wrapper calendar-restructure-sb']";
	        //click date text field
	        basedriver_wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(departDateFieldXpath)));
